// Напишите пр-му, которая принимает на вход координаты двух точек и находит расстояние между ними в 2D 
...
{
    double result =Math.Round(Math.Sqrt(Math.Pow(A[0]-B[0],2) + Math.Pow(A[1]-B[1],2)),2);
    return result;
}
int [] a = new int[2];
int [] b = new int[2];
